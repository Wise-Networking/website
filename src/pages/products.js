...
const Products = props => {
  ...
  return (
    <Layout location="products" keywords="products, wise networking" title="Products | Dandelions offers a number of different solutions for your IOT project. How can we help?">
